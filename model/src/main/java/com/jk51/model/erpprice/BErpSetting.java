 ...
 * @author 
 */
public class BErpSetting implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        BErpSetting other = (BErpSetting) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getSiteId() == null ? other.getSiteId() == null : this.getSiteId().equals(other.getSiteId()))
            && (this.getType() == null ? other.getType() == null : this.getType().equals(other.getType()))
            && (this.getIsJoint() == null ? other.getIsJoint() == null : this.getIsJoint().equals(other.getIsJoint()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsJoint() == null) ? 0 : getIsJoint().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", isJoint=").append(isJoint);
