...
public class SClerkDetail {
    ...
    private String aliqrcode_url;

    public void setAliqrcode_url(String aliqrcode_url) {
        this.aliqrcode_url = aliqrcode_url;
    }

    public String getAliqrcode_url() {
        return aliqrcode_url;
    }
