...
public class MerchantExtTreat {
    ...
    private Integer has_erp_price;
    private Integer integral_shop;
    private String integral_name;

    private Integer logistics_flag_jk;
    private Integer logistics_flag_merchant;
    private Integer logistics_flag_mode;
    private Integer health_file;

    private Integer instock;

    private Integer trades_storage;

    private Integer wx_template_flag;

    private Integer self_taken_flag;

    private String baidu_script;

    private Integer device_flag;

    public String getBaidu_script() {
        return baidu_script;
    }

    public void setBaidu_script(String baidu_script) {
        this.baidu_script = baidu_script;
    }
    ...
    public Integer getWx_template_flag() {
        return wx_template_flag;
    }

    public void setWx_template_flag(Integer wx_template_flag) {
        this.wx_template_flag = wx_template_flag;
    }

    public Integer getTrades_storage() {
        return trades_storage;
    }

    public void setTrades_storage(Integer trades_storage) {
        this.trades_storage = trades_storage;
    }
    ...
    public Integer getLogistics_flag_jk() {
        return logistics_flag_jk;
    }

    public void setLogistics_flag_jk(Integer logistics_flag_jk) {
        this.logistics_flag_jk = logistics_flag_jk;
    }

    public Integer getLogistics_flag_merchant() {
        return logistics_flag_merchant;
    }

    public void setLogistics_flag_merchant(Integer logistics_flag_merchant) {
        this.logistics_flag_merchant = logistics_flag_merchant;
    }

    public Integer getlogistics_flag_mode() {
        return logistics_flag_mode;
    }

    public void setlogistics_flag_mode(Integer logistics_flag_mode) {
        this.logistics_flag_mode = logistics_flag_mode;
    }

    private Integer has_storage;

    public Integer getHas_storage() {
        return has_storage;
    }

    public void setHas_storage(Integer has_storage) {
        this.has_storage = has_storage;
    }

    private Integer check_manage;

    public Integer getCheck_manage() {
        return check_manage;
    }

    public void setCheck_manage(Integer check_manage) {
        this.check_manage = check_manage;
    }

    public Integer getIntegral_shop() {
        return integral_shop;
    }

    public void setIntegral_shop(Integer integral_shop) {
        this.integral_shop = integral_shop;
    }
    ...
    public void setHas_erp_price(Integer has_erp_price) {
        this.has_erp_price = has_erp_price;
    }

    public Integer getHas_erp_price() {
        return has_erp_price;
    }
    ...
    public Integer getHealth_file() {
        return health_file;
    }

    public void setHealth_file(Integer health_file) {
        this.health_file = health_file;
    }
