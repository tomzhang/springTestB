...
public class MerchantTreat implements Serializable {
    private Integer id;
    ...
    private Integer erp_fault_center;

    public Integer getErp_fault_center() {
        return erp_fault_center;
    }

    public void setErp_fault_center(Integer erp_fault_center) {
        this.erp_fault_center = erp_fault_center;
    }

    public String getMerchant_card_id() {
        return merchant_card_id;
    }

    public void setMerchant_card_id(String merchant_card_id) {
        this.merchant_card_id = merchant_card_id;
    }
    ...
    private Integer imdada_flag;

    public Integer getImdada_flag() {
        return imdada_flag;
    }

    public void setImdada_flag(Integer imdada_flag) {
        this.imdada_flag = imdada_flag;
    }
    ...
    public Integer getAlipay_flag() {
        return alipay_flag;
    }

    public void setAlipay_flag(Integer alipay_flag) {
    ...
    private Integer offintegral_use;

    public Integer getOffintegral_use() {
        return offintegral_use;
    }

    public void setOffintegral_use(Integer offintegral_use) {
        this.offintegral_use = offintegral_use;
    }
