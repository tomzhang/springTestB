...
public class QRCodeUtil {
    ...
    private static BufferedImage createImage(String content, String logoPath, boolean needCompress) throws Exception {
        ...
        hints.put(EncodeHintType.CHARACTER_SET, CommonConstant.CHARSET);
    ...
    public static String encode(String content, String logoPath, String destPath, boolean needCompress) throws Exception {
        ...
        mkdirs(destPath);
        String fileName = Instant.now().toEpochMilli() + "." +  CommonConstant.FORMAT.toLowerCase();
        ImageIO.write(image, CommonConstant.FORMAT, new File(destPath + "/" + fileName));
        return fileName;
    ...
    public static String encode(String content, String logoPath, String destPath, String fileName, boolean needCompress) throws Exception {
        BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
        mkdirs(destPath);
        fileName = fileName.substring(0, fileName.indexOf(".") > 0 ? fileName.indexOf(".") : fileName.length()) + "." +  CommonConstant.FORMAT.toLowerCase();
        ImageIO.write(image,  CommonConstant.FORMAT, new File(destPath + "/" + fileName));
        return fileName;
    }
    ...
    public static void encode(String content, String logoPath, OutputStream output, boolean needCompress) throws Exception {
        BufferedImage image = QRCodeUtil.createImage(content, logoPath, needCompress);
        ImageIO.write(image,  CommonConstant.FORMAT, output);
    }
