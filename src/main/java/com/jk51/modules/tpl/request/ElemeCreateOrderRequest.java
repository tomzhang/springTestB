...
public class ElemeCreateOrderRequest extends AbstractRequest {
    ...
    public static class ElemeCreateRequestData {
         ...
         *
         */
        private ElemeCreateOrderRequest.ItemsJson[] items_json;
        ...
        public ElemeCreateOrderRequest.ItemsJson[] getItems_json() {
            return items_json;
        }

        public void setItems_json(ElemeCreateOrderRequest.ItemsJson[] items_json) {
