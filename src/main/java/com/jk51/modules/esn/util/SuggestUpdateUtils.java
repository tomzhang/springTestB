...
@Component
public class SuggestUpdateUtils {

    private static final Logger log = LoggerFactory.getLogger(SuggestUpdateUtils.class);
    ...
    public void batchInsert(String index, String shopid, List list, String idName){
        ...
        list.parallelStream().forEach(o -> {
            ...
            try {
                ...
                processor.add(client.prepareIndex(index, shopid, goodsid).setRouting(shopid)
                        .setSource(mapper.writeValueAsString(o).replaceAll("NULL","")).request());
            }catch (Exception e){
    ...
    public void defineSuggestTypeMapping(String index,String type) {
        ...
        try {
            ...
            mapBuilder.startObject()
                    ...
                    .startObject("keyword_py").field("type","string").field("similarity","base").field("search_analyzer","lc_search").field("analyzer","lc_index").endObject()
            ...
            PutMappingRequest putMappingRequest = Requests
                    ...
                    .source(mapBuilder).updateAllTypes(true);
...
//                    .startObject("drug_name").field("type", "string").endObject()
...
//                    .endObject()
//                    .endObject()
//                    .startObject("goods_shouzimu").field("type", "string").endObject()
...
//                    .startObject("shop_price").field("type", "long").endObject()
