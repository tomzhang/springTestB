 ...
 * 修改记录:
 */
public class PandianOrderStatusParam {

    private String pandian_num;
    private String createTime;
    private String endTime;
    private Integer status;
    private String profitOrLossStatu;
    ...
    public String getProfitOrLossStatu() {
        return profitOrLossStatu;
    }

    public void setProfitOrLossStatu(String profitOrLossStatu) {
