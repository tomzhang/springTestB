...
import com.jk51.modules.pay.service.ali.request.ExtendParams;
 ...
 */
@Component
public class AliPayApifw {
    private static final Logger log = LoggerFactory.getLogger(AliPayApifw.class);

    @Autowired
    AliConfig aliConfigold;
    @Autowired
    AliConfigfw aliConfig;
    ...
    public AlipayTradePrecreateResponse precreate(AliRequestParam aliRequestParam) throws Exception {
        ...
        AliConfig aliConfigsub = toConfigToken(aliRequestParam.getOut_trade_no());
        ...
        params.setSys_service_provider_id(aliConfigsub.getPid());
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradePrecreateResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public AlipayTradeQueryResponse query(AliRequestParam aliRequestParam) throws Exception  {
        ...
        AliConfig aliConfigsub = toConfig(aliRequestParam.getOut_trade_no());
        alipayClient = new DefaultAlipayClient(PayConstant.ALI_REQUEST_URL,
                aliConfig.getApp_id(),aliConfig.getPrivate_key(),"json",
                "utf-8",aliConfig.getAli_public_key(),"RSA2");
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeQueryResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
    ...
    public AlipayTradeRefundResponse refund(AliRequestParam aliRequestParam) throws Exception {
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeRefundResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        if("40004".equals(response.getCode())){
            response=this.refundphone(aliRequestParam);
        }
        return response;
    }
    /**
     ...
     * @throws Exception
     */
    public AlipayTradeRefundResponse refundphone(AliRequestParam aliRequestParam) throws Exception {
        if(StringUtil.isEmpty(aliRequestParam.getOut_trade_no()) && StringUtil.isEmpty(aliRequestParam.getTrade_no())) {
            throw new PayException("订单退款接口中，out_trade_no、trade_no至少填一个！ ");
        } else if(StringUtil.isEmpty(aliRequestParam.getRefund_amount())) {
            throw new PayException("缺少订单退款接口必须参数refund_amount！ ");
    ...
    public AlipayTradePayResponse pay(AliRequestParam aliRequestParam) throws Exception{
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradePayResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public AlipayTradeCancelResponse cancel(AliRequestParam aliRequestParam) throws Exception{
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeCancelResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public AlipayTradeCreateResponse create(AliRequestParam aliRequestParam) throws Exception {
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeCreateResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public AlipayTradeFastpayRefundQueryResponse queryRefund(AliRequestParam aliRequestParam) throws Exception  {
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeFastpayRefundQueryResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public AlipayTradeCloseResponse close(AliRequestParam aliRequestParam) throws Exception {
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeCloseResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public AlipayTradeOrderSettleResponse settle(AliRequestParam aliRequestParam) throws Exception {
        ...
        aliRequestParam.setExtend_params(params);
        request.setBizContent(JacksonUtils.obj2jsonIgnoreNull(aliRequestParam));
        AlipayTradeOrderSettleResponse response = alipayClient.execute(request,null,aliConfigsub.getApp_auth_token());
        return response;
    }
    ...
    public Map alipayTradeWapPay(String tradeId, String reUrl,String product_code){
        ...
        try {
            ...
            AliConfig aliConfigsub = toConfig(tradeId);
            AlipayClient client = new DefaultAlipayClient(aliConfig.getUrl(), aliConfigsub.getApp_id(), aliConfigsub.getPrivate_key(), aliConfig.getFormat(), aliConfig.getCharset(), aliConfigsub.getAli_public_key(), aliConfig.getSign_type());
            ...
            alipay_request.setNotifyUrl(aliConfig.getPnotify_url());
    ...
    public AliConfig toConfig(String tradeId) throws IllegalAccessException{
        ...
        if("NO".equals(fw)||payMap==null)return aliConfigold;
        if(StringUtil.isEmpty(payMap.get("ali_seller_id"))){
            return toConfigToken(tradeId);
        }
        AliConfig aliConfig=new AliConfig(
                ...
                aliConfigold.getNotify_url(), payMap.get("ali_public_key").toString(),
                payMap.get("ali_log_path").toString(),  payMap.get("ali_return_url").toString());
        aliConfig.setApp_auth_token((payMap.get("ali_app_auth_token")+"").trim());
        aliConfig.setPid((payMap.get("ali_pid")+"").trim());
        return aliConfig;
    }
    public AliConfig toConfigToken(String tradeId) throws IllegalAccessException{
        ...
        if("NO".equals(fw)||payMap==null)return aliConfigold;
        AliConfig aliConfig=new AliConfig();
        aliConfig.setApp_auth_token(payMap.get("ali_app_auth_token")+"");
        aliConfig.setPid(payMap.get("ali_pid")+"");
        return aliConfig;
    }
    public AliConfig toConfigSiteId(Integer siteId) throws IllegalAccessException{
        Map<String,Object> params=new HashedMap();
        params.put("siteId",siteId);
        Map<String,Object> payMap = discountMapper.getPayAliWx(params);
        //查看该商家是否是服务商商户
     ...
     * @throws Exception
     */
    public String downloadurlQuery(Integer siteId,String bill_date) throws Exception {
        if(StringUtil.isEmpty(siteId)) {
            throw new PayException("订单关闭接口中，siteId必填！ ");
        }
        AliConfig aliConfigsub = toConfigSiteId(siteId);
        alipayClient = new DefaultAlipayClient(PayConstant.ALI_REQUEST_URL,
                aliConfig.getApp_id(),aliConfig.getPrivate_key(),"json",
                "utf-8",aliConfig.getAli_public_key(),"RSA2");
        ...
        request.setBizContent("{" +
                ...
                "\"bill_date\":\""+bill_date+"\"" +
                "  }");
        AlipayDataDataserviceBillDownloadurlQueryResponse response = alipayClient.execute(request, null,aliConfigsub.getApp_auth_token());
