 ...
 */
@Component
public class AliConfigMerchant {
    ...
    public AliConfigMerchant() {
    }

    public AliConfigMerchant(String app_id, String seller_id, String private_key, String public_key, String notify_url, String ali_public_key, String log_path, String return_url) {
        this.app_id = app_id;
