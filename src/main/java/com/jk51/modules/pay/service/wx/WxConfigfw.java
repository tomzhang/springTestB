 ...
 */
@Component
@ConfigurationProperties(prefix = "pay.wxpayfw")
public class WxConfigfw {
    ...
    public WxConfigfw(String appid, String APPSECRET, String mch_id, String notify_url, String spbill_create_ip, String key, String cert_path, String mp_verify_path) {
        this.appid = appid;
